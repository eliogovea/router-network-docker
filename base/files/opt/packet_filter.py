...
def inspect_packet(pkt):
    ...
    logger.info(f"[id={packet_id}] summary: {packet_data_scapy.summary()}")
    logger.info(f"[id={packet_id}] src IP:  {packet_data_scapy.src}")
    logger.info(f"[id={packet_id}] dst IP:  {packet_data_scapy.dst}")
    logger.info(f"[id={packet_id}] verdict: accept")
